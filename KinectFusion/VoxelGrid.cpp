...
{
	if (x >= resolution || y >= resolution || z >= resolution) { return 0.0f; }
...
VoxelGrid VoxelGrid::operator* (const VoxelGrid & rhs)
{
	...
	/*std::cout << "#1: " << sizeof(voxelData) / sizeof(float) << std::endl;
	std::cout << "#2: " << sizeof(rhs.voxelData) / sizeof(float) << std::endl;
	std::cout << "#3: " << sizeof(elemProd.voxelData) / sizeof(float) << std::endl;
	std::cout << "#numElements: " << numElements << std::endl;
	std::cout << voxelData[0] << std::endl;
	std::cout << rhs.voxelData[0] << std::endl;
	std::cout << elemProd.voxelData[0] << std::endl;*/
	for (int i = 0; i < numElements; ++i) {
